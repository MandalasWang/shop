	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
      ...
      <c:forEach items="${pageBean.list }" var="pro">
           <div class="col-md-2" style="height:250px">
			 <a href="${pageContext.request.contextPath }/product?method=product_info&pimage=${pro.pimage }&cid=${pro.cid}&pid=${pro.pid}"> 
			      <img src="${pro.pimage }"width="170" height="170" style="display: inline-block;">
			 </a>
			 <p>
				<a href="${pageContext.request.contextPath }/product?method=product_info&pimage=${pro.pimage }&cid=${pro.cid}&pid=${pro.pid}" style='color: green'>${pro.pname }</a>
			 </p>
			 <p>

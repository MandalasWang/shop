...
function searchinfo(oid) {
	window.location.href = "${pageContext.request.contextPath}/Admin?method=getproductinfo&pid="+pid;
}
</script>
</HEAD>
<body>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="14%">商品数</td>
								<td align="center" width="14%">商品信息</td>
							...
							<c:forEach items="${items }" var="item" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="14%">${item.count }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="14%">${item.subtotal }</td>

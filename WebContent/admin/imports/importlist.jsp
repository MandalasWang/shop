...
<script type="text/javascript">
	...
	/* function delproduct(pid) {
		var isdel = confirm("您确认要进货吗？");
		if (isdel) {
			//确认删除
			window.localtion.href = "${pageContext.request.contextPath}/Admin?method=importBypid&pid="
					+ pid;
		}
	} */
</script>
...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/Admin?method=importsearchprolist"
		method="post">
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="8%">商品库存</td>
								<td align="center" width="8%">商品进货统计</td>
								<td align="center" width="10%">进货管理</td>
							...
							<c:forEach items="${list }" var="pro" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="24%">${pro.pname }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="14%">${pro.shop_price }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%">${pro.is_hot==1?"是":"否" }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%">${pro.counts }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%">${pro.importconts }</td>		
									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/Admin?method=importBypid&pid=${pro.pid}" >
											<button style="CURSOR: hand">我要进货</button>
									</a></td>	
									<%-- <td align="center" style="HEIGHT: 22px"><a

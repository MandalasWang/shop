	...
	<body>
		...
		<c:if test="${!empty cart.cartItems }">
			...
			<div class="container">
				...
				&nbsp; 商品金额: <strong style="color:#ff6600;">￥${cart.total }元</strong>
					...
					<a href="${pageContext.request.contextPath }/product?method=submitOrder"><input type="button" width="100" value="提交订单" name="submit" border="0" style="background: 
		...
		<c:if test="${empty cart.cartItems }">
			<div align="center" >
				...
				<img width="500px" height="450px" alt="" src="${pageContext.request.contextPath }/images/cart-empty.png">		
			
			</div>
			<div align="right" style="margin-top:20px;margin-right:200px">
			    <em><a style="font-weight:bold;font-size:18px;"
			    href="${pageContext.request.contextPath }/product?method=index">返回首页</a></em>
			</div>
		</c:if>
